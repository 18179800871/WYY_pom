...
# 断言
assert_text = '1520147747'

assert assert_text  == driver.find_element(by='xpath' , value='/html/body/div[6]/div/div[1]/div[1]/em/span/em[2]').text,"断言失败"
#搜索iphone6
...
driver.save_screenshot('./img/test01.png')
